...
"""
@author: Zongyi Li
This file is from the Fourier Neural Operator for 2D problem such as the Darcy Flow discussed in Section 5.2 in the [paper](https://arxiv.org/pdf/2010.08895.pdf).
"""
...
class CosineWithWarmupScheduler(LambdaLR):
    def __init__(
        ...
        lr_lambda = CosineLRLambda(num_warmup_steps, num_training_steps, num_cycles)
